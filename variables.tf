...
variable "resource_tags" {
  type        = list(string)
  description = "Add user resource tags to the Key Protect instance instance to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types)."
  default     = []
  validation {
...
variable "access_tags" {
  type        = list(string)
  description = "Add access management tags to the Key Protect instance instance to control access. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#create-access-console)."
  default     = []
}
