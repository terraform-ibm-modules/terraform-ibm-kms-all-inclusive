...
output "kms_guid" {
  ...
  value       = module.fully_configurable.kms_guid
}

output "kms_account_id" {
  description = "The account ID of the KMS instance."
  value       = module.fully_configurable.kms_account_id
}

output "key_protect_id" {
  description = "Key Protect instance ID when an instance is created, otherwise null"
  value       = module.fully_configurable.key_protect_id
}

output "kms_instance_crn" {
  value       = var.existing_kms_instance_crn == null ? module.fully_configurable.key_protect_crn : var.existing_kms_instance_crn
...
output "key_protect_name" {
  ...
  value       = module.fully_configurable.key_protect_name
}
