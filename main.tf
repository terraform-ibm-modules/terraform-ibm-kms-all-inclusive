...
module "key_protect" {
  ...
  source                            = "git::https://github.com/terraform-ibm-modules/terraform-ibm-key-protect.git?ref=v2.2.1"
...
module "key_protect_keys" {
  ...
  source = "git::https://github.com/terraform-ibm-modules/terraform-ibm-key-protect-key.git?ref=v1.1.0"
